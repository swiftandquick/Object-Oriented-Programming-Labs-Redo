...
/**
 * LinkedList referred to these classes. For reference, go to OOP lecture 19.
 * Hint: If I don't understand the code, but the other programmer put the
 * description on the methods, I can still use the methods to manipulate data.
 */
