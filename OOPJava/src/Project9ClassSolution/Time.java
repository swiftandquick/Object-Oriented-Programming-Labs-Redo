...
public class Time {
	 ...
	 * @param initialMinutes 60-minute format in range 0...59
	 * <p>
	 * postconditions: If the specified hours and minutes are in-range, the
	 * object will recall the parameter but the time will be set to 0 hours and
	 * 0 minutes (12:00 midnight) if either or both values are out of range
	 */
	 ...
	 * @param initialHours 24-hour format in the range 0...12 
	 * @param initialMinutes 60-minute format in range 0...59
	 * @param isAM is a boolean, if hours <= 12, isAM is am, if hours > 12, isAM is not am
	 * <p>
	 * postconditions: If the specified hours and minutes are in-range, the
	 * object will recall the parameter but the time will be set to 0 hours and
	 * 0 minutes (12:00 midnight) if either or both values are out of range
	 ...
	 * If time is not valid, hours and minutes will remain 
	 * as the previous inserted hours and minutes.  hours 
	 * and minutes will only update equal to newHours and 
	 * newMinutes if isValid() is true.  
	 * <p>
	 * postconditions: 
	 */	
	...
	/**
	 * 
	 * Creates a boolean method to check whether the hours and minutes are in range.  
	 * <p>
	 * postconditions: 
	 */	
